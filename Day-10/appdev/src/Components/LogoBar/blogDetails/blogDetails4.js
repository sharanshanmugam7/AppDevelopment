...
import photo1 from "./blogContent6.jpg";
import photo2 from "./blogContent7.jpg";
    ...
    <div className="blogDetails">
      ...
      <div className="blogDetailsAll">
        <div className="blog-content">
          <h1>Let's Get Solution for Terracotta Painting Work</h1>
          ...
          <div className="bc-text t3">
            ...
            <container>
              <div className="map">
        <iframe
          src="https://youtube.com/embed/I5LeaBKRrJM?feature=shared"
          title="map"
          style={{
            frameborder: "0",
            allowfullscreen: "",
        ...
        ></iframe>
          ...
          <container>
              <div className="map">
        <iframe
          src="https://youtube.com/embed/Pca9J0_U18U?feature=shared"
          title="map"
          style={{
            frameborder: "0",
            allowfullscreen: "",
