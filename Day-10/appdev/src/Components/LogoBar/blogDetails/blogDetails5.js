...
import photo1 from "./blogContent8.jpg";
import photo2 from "./blogContent9.jpg";
import { Link } from "react-router-dom";


export function BlogDetails5() {
      ...
      <div className="blogDetailsAll">
        <div className="blog-content">
          ...
          <div className="bc-text t3">
            ...
            <container>
              <div className="map">
        <iframe
          src="https://youtube.com/embed/IfQ_k8fDIWs?feature=shared"
          title="map"
          style={{
            frameborder: "0",
            allowfullscreen: "",
        ...
        ></iframe>
          ...
          <container>
              <div className="map">
        <iframe
          src="https://youtube.com/embed/2mVZwPfCRD8?feature=shared"
          title="map"
          style={{
            frameborder: "0",
            allowfullscreen: "",
