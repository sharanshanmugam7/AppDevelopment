...
import photo1 from "./blogContent.jpg";
import photo2 from "./blogContent3.webp";
    ...
    <div className="blogDetails">
      ...
      <div className="blogDetailsAll">
        <div className="blog-content">
          <h1>Let's Get Solution for Wall Sconce Work</h1>
          <div className="bc-photo">
            <img src={photo1} alt="blog"></img>
          </div>
          <div className="datePath">
            <p className="date">26 December 2023</p>
          ...
          <div className="bc-text t3">
            ...
            <container>
              <div className="map">
        <iframe
          src="https://youtube.com/embed/nmecXOCGFp4?feature=shared"
          title="map"
          style={{
            frameborder: "0",
            allowfullscreen: "",
        ...
        ></iframe>
          ...
          <container>
              <div className="map">
        <iframe
          src="https://youtube.com/embed/epk2N01UNsg?si=vEHusi1A6jIMzI5I"
          title="map"
          style={{
            frameborder: "0",
            allowfullscreen: "",
