...
import photo1 from "./blockContent4.jpeg";
import photo2 from "./blogContent5.jpg";
    ...
    <div className="blogDetails">
      ...
      <div className="blogDetailsAll">
        <div className="blog-content">
          <h1>Let's Get Solution for Terracotta Pots Work</h1>
          ...
          <div className="bc-text t3">
            ...
            <container>
              <div className="map">
        <iframe
          src="https://youtube.com/embed/br2FboUhLCg?feature=shared"
          title="map"
          style={{
            frameborder: "0",
            allowfullscreen: "",
        ...
        ></iframe>
          ...
          <container>
              <div className="map">
        <iframe
          src="https://youtube.com/embed/o8pK0pD8wiE?feature=shared"
          title="map"
          style={{
            frameborder: "0",
            allowfullscreen: "",
